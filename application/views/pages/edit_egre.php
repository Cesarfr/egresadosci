					...
					<div class="row">
						...
						<div class="col-sm-2 col-md-2">
							<div class="form-group">
								...
								<input type="radio" name="egresado" id="egresadoING" value="ING" checked="checked">
								<label for="egresadoING">ING</label>
								<?php }else{?>
								<input type="radio" name="egresado" id="egresadoTSU" value="TSU" data-validation="required" data-sanitize="trim escape" checked="checked">
								<label for="egresadoTSU">TSU</label>
